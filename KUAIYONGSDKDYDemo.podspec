Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/yuhaomingming/KUAIYONGSDKDYDemo.git", :tag => "0.0.16" }
  s.public_header_files = "Common/SDK/Platform/KUAIYONGSDK/DYFramework/QuickUnifyPlatform.framework/**/*.h"
